...
After applying the complete substitution key, the ciphertext was fully decrypted.
The resulting plaintext is a coherent English article discussing the Oscars, award-season politics, #MeToo movement, and industry commentary.

Below is the recovered plaintext (excerpted from in7.txt):
...
AVOID CONFLICTING WITH THE CLOSING CEREMONY OF THE WINTER OLYMPICS IN
PYEONGCHANG
...
…
(plaintext continues as in your screenshots)
